...
import dockerHtml from '../data/guides/docker-guide.html?raw';

export const DockerLibraryView: React.FC<{ switchView?: (v: string) => void }> = ({ switchView }) => {
  return (
    <div style={{
      position: 'fixed',
      top: 0,
      ...
      <div style={{ display: 'flex', alignItems: 'center', padding: '16px 20px', borderBottom: '1px solid #1f1f1f', background: '#0d0d0d' }}>
        ...
        <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 'bold' }}>Docker Knowledge Library</h2>
      </div>
