...
import k8sAdvancedHtml from '../data/guides/k8s-advanced-guide.html?raw';

export const K8sAdvancedLibraryView: React.FC<{ switchView?: (v: string) => void }> = ({ switchView }) => {
  return (
    <div style={{
      position: 'fixed',
      top: 0,
      ...
      <div style={{ display: 'flex', alignItems: 'center', padding: '16px 20px', borderBottom: '1px solid #1f1f1f', background: '#0d0d0d' }}>
        ...
        <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 'bold' }}>Advanced Kubernetes & GitOps</h2>
      </div>

      {/* Content */}
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden', background: '#000' }}>
        <iframe 
          srcDoc={k8sAdvancedHtml} 
          title="Advanced Kubernetes Guide" 
